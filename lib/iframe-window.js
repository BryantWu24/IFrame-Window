var IFrame_Window = {
    ...
    createWindow: function (url, width, height) {
        ...
        if (!!IFrame_Window.element.divOuter) {
            IFrame_Window.element.divMask.style.display='flex';
            IFrame_Window.element.iframe.onload = function () {
                IFrame_Window.createDargEvent();
                IFrame_Window.element.divMask.style.display = 'none';
            ...
            divMask.style.borderRadius = '10px';
            divMask.style.height = '100%';
            divMask.style.background = 'white';
            divMask.style.zIndex = 10000;
            divMask.style.position = 'relative';
            divMask.style.display = 'flex';
            divMask.style.justifyContent = 'center';
            divMask.style.alignItems = 'center';
            divMask.id = 'divMask';
            divMask.innerHTML = "<div>Loading...</div>"
            ...
            divOuter.innerHTML = divMask.outerHTML + divBar.outerHTML + divIframe.outerHTML;
            ...
            IFrame_Window.element.divMask = document.getElementById('divMask');
